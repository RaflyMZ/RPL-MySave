...
<section class="p-6">
    <div class="container mx-auto max-w-md bg-white rounded-lg shadow-md p-6">
        ...
        <div class="flex flex-col items-center mb-4" >
            <button class="bg-green-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Ganti Foto</button>
        </div>
        <div class="flex flex-col items-center mb-4" >
            <button class="bg-red-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Hapus Foto</button>
        </div>
        <!-- Form -->
        <form action="#">
            ...
            <div class="flex flex-col items-center" >
                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Simpan Perubahan</button>
            </div>
        </form>
